...
# import PIL.ImageOps
# #读入图片
# image = Image.open('./Data/liver/train/000_mask.png')
# #反转
# inverted_image = PIL.ImageOps.invert(image)
# #保存图片
# inverted_image.save('./Data/new_name.png')
...
pic_dir = './Data/liver/train/000.png'
...
def get_picture_rgb(picture_dir):
    ...
    '''
    img = skimage.io.imread(picture_dir)
    img256 = skimage.transform.resize(img, (512, 512))
    skimage.io.imsave('./Data/000.png', img256)
